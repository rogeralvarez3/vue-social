...
- **Publicaciones** (`/`): feed con **scroll infinito real** (carga más
  publicaciones automáticamente al acercarte al final), texto, foto, vídeo o
  audio (un adjunto por publicación), reacciones estilo Facebook (👍 ❤️ 😆
  😮 😢 😡) y comentarios en **árbol** (respuestas anidadas ilimitadas), todo
  en tiempo real vía Socket.io. Por defecto solo muestra publicaciones de tu
  ciudad; hay un botón para ver todas las ciudades o elegir una en concreto
  (tu elección se recuerda entre sesiones). Cualquier foto/vídeo/audio
  publicado aquí aparece automáticamente también en su sección
