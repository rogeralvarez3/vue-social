    ...
    <div class="avatar-row">
      ...
      <div class="ml-3 flex-grow-1 text-truncate">
        <div class="d-flex align-center ga-1">
          <span class="text-subtitle-1 font-weight-bold text-truncate">{{ user?.fullName || user?.username }}</span>
          <v-icon v-if="user?.accountType === 'negocio'" icon="mdi-storefront-outline" size="16" color="primary" />
        </div>
